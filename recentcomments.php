...
$sqlquery=$conn->query("select f.uname2, c.pname, date(now())-date(c.commtime) from follows f,comments c where f.uname1 ='$user_name' and f.uname2 = c.uname order by c.commtime desc ; ;");
?>
...
<div class="container">
  <ul class="nav nav-pills">
    ...
    <li class="active"><a href="recentcomments.php">Comments</a></li>
    ...
    <div class="container" style="margin-top:20px;">
      <div class="row">
        <div class="col-md-11"> 
            ...
            <i class="glyphicon glyphicon-user icon-activity"></i> <a href="#">'.$row[0].'</a> commented on <a href="#">'.$row[1].'</a>
        </div>
      </div>
    </div>
    <hr>';
